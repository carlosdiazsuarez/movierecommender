    ...
    while film_to_search != '':    
        ...
        for source in metadata_content:
            ...
            if (source['query_type']) == 'TWITTER_Topic':
                ...
                # get all triples from film in source
                film_all_triples = []
                film_all_triples = TWITTER_SOURCE_request_movie_info(film_to_search, source, metadata_mappings, metadata_content)
    ...
    for source in metadata_content:
        ...
        if (source['query_type']) == 'SPARQL':
            ...
            for movie in movies:                       
                ...
                # get all triples from film in source
                movie_triples = []
                DBPEDIA_request_movie_info(movie_uri, source, metadata_mappings, metadata_content)                                                
